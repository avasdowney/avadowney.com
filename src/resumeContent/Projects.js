...
const Projects = () => {
    return (
        <header>
            <h2> Activity Decider Amazon Alexa Skill </h2>
            <p>
                ...
                <a href="https://docs.google.com/document/d/1mzMih_fTALBqf-PJeg5t31mxPpvH9n41RUF_D3mPWJc/edit" target='_blank' rel='noopener' class='no-decoration'> "how-to" </a> 
                guide to explain my process making the skill, learning GitHub, Travis CI, and much more.
                Click <a href="https://github.com/avasdowney/alexa-decision-maker" target='_blank' rel='noopener' class='no-decoration'> here </a> 
